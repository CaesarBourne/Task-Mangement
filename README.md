...
A full Postman collection is available in this directory path that covers:
...
| Enhancement             | Benefit                        |
| ----------------------- | ------------------------------ |
| Role based access       | Not all uisers should be able to assign create tasks and persons |
| Pagination              | Better task retrieval at scale |
| Swagger / OpenAPI       | Auto-generated API docs        |
| Unique email validation | More robust person management and user access control  |
| Domain events           | Advanced DDD patterns          |
| Testing support         | Writing more test cases that pass |
